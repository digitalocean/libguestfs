...
static int test_mke2journal_U_0 (void)
{
  ...
  {
    const char *uuid = "279bff52-ed3c-4e94-8e52-08bf47a8a8f8";
    const char *device = "/dev/sda1";
    int r;
    suppress_error = 0;
...
static int test_swapon_uuid_0 (void)
{
  ...
  {
    const char *uuid = "2b001572-f021-4913-9640-49b361b02695";
...
static int test_mkswap_U_0 (void)
{
  ...
  {
    const char *uuid = "ff713368-fbec-4e2c-8da9-518cd39d731e";
    const char *device = "/dev/sda1";
    int r;
    suppress_error = 0;
    r = guestfs_mkswap_U (g, uuid, device);
...
static int test_set_e2uuid_0 (void)
{
  ...
  const char *expected = "f87583ce-5757-4ea2-a4cd-e79e5f305825";
  {
    const char *device = "/dev/sda1";
    const char *uuid = "f87583ce-5757-4ea2-a4cd-e79e5f305825";
    int r;
    suppress_error = 0;
