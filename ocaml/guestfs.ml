...
external add_drive : t -> ?readonly:bool -> ?format:string -> ?iface:string -> ?name:string -> ?label:string -> ?protocol:string -> ?server:string array -> ?username:string -> ?secret:string -> ?cachemode:string -> ?discard:string -> ?copyonread:bool -> string -> unit = "guestfs_int_ocaml_add_drive_byte" "guestfs_int_ocaml_add_drive"
...
external add_drive_scratch : t -> ?name:string -> ?label:string -> int64 -> unit = "guestfs_int_ocaml_add_drive_scratch"
...
external hivex_open : t -> ?verbose:bool -> ?debug:bool -> ?write:bool -> string -> unit = "guestfs_int_ocaml_hivex_open"
