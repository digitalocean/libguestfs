...
module Errno = struct
  ...
  external enoent : unit -> int = "ocaml_guestfs_get_ENOENT" "noalloc"
...
external add_libvirt_dom : t -> ?readonly:bool -> ?iface:string -> ?live:bool -> ?readonlydisk:string -> ?cachemode:string -> ?discard:string -> ?copyonread:bool -> int64 -> int = "ocaml_guestfs_add_libvirt_dom_byte" "ocaml_guestfs_add_libvirt_dom"
...
external btrfs_image : t -> ?compresslevel:int -> string array -> string -> unit = "ocaml_guestfs_btrfs_image"
...
external btrfs_replace : t -> string -> string -> string -> unit = "ocaml_guestfs_btrfs_replace"
...
external btrfstune_enable_extended_inode_refs : t -> string -> unit = "ocaml_guestfs_btrfstune_enable_extended_inode_refs"
external btrfstune_enable_skinny_metadata_extent_refs : t -> string -> unit = "ocaml_guestfs_btrfstune_enable_skinny_metadata_extent_refs"
external btrfstune_seeding : t -> string -> bool -> unit = "ocaml_guestfs_btrfstune_seeding"
...
external copy_device_to_device : t -> ?srcoffset:int64 -> ?destoffset:int64 -> ?size:int64 -> ?sparse:bool -> ?append:bool -> string -> string -> unit = "ocaml_guestfs_copy_device_to_device_byte" "ocaml_guestfs_copy_device_to_device"
external copy_device_to_file : t -> ?srcoffset:int64 -> ?destoffset:int64 -> ?size:int64 -> ?sparse:bool -> ?append:bool -> string -> string -> unit = "ocaml_guestfs_copy_device_to_file_byte" "ocaml_guestfs_copy_device_to_file"
external copy_file_to_device : t -> ?srcoffset:int64 -> ?destoffset:int64 -> ?size:int64 -> ?sparse:bool -> ?append:bool -> string -> string -> unit = "ocaml_guestfs_copy_file_to_device_byte" "ocaml_guestfs_copy_file_to_device"
external copy_file_to_file : t -> ?srcoffset:int64 -> ?destoffset:int64 -> ?size:int64 -> ?sparse:bool -> ?append:bool -> string -> string -> unit = "ocaml_guestfs_copy_file_to_file_byte" "ocaml_guestfs_copy_file_to_file"
...
external internal_exit : t -> unit = "ocaml_guestfs_internal_exit"
...
external part_get_gpt_guid : t -> string -> int -> string = "ocaml_guestfs_part_get_gpt_guid"
...
external part_get_mbr_part_type : t -> string -> int -> string = "ocaml_guestfs_part_get_mbr_part_type"
...
external part_set_gpt_guid : t -> string -> int -> string -> unit = "ocaml_guestfs_part_set_gpt_guid"
...
external set_uuid_random : t -> string -> unit = "ocaml_guestfs_set_uuid_random"
