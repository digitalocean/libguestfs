...
external add_domain : t -> ?libvirturi:string -> ?readonly:bool -> ?iface:string -> ?live:bool -> string -> int = "ocaml_guestfs_add_domain_byte" "ocaml_guestfs_add_domain"
...
external mkfs_opts : t -> ?blocksize:int -> ?features:string -> string -> string -> unit = "ocaml_guestfs_mkfs_opts"
...
external test0 : t -> string -> string option -> string array -> bool -> int -> int64 -> string -> string -> string -> unit = "ocaml_guestfs_test0_byte" "ocaml_guestfs_test0"
