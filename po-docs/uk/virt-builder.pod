...
will be F<fedora-25.img>.  You can change the output filename using the
I<-o> option:
...
L<virt-customize(1)>, L<virt-get-kernel(1)>, L<virt-install(1)>,
L<virt-rescue(1)>, L<virt-resize(1)>, L<virt-sysprep(1)>, L<oz-install(1)>,
L<gpg(1)>, L<gpg2(1)>, L<curl(1)>, L<virt-make-fs(1)>, L<genisoimage(1)>,
