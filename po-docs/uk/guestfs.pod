...
L<virt-win-reg(1)>, L<guestfs-testing(1)>, L<libguestfs-test-tool(1)>,
...
Для звітування щодо вад у libguestfs скористайтеся цим посиланням:

L<https://bugzilla.redhat.com/enter_bug.cgi?component=libguestfs&product=Virtualization+Tools>

Під час створення повідомлення щодо вади вам слід переконатися:

=over 4

=item *

Що про ваду вже не повідомлено кимось іншим.

=item *

Що ви користуєтеся найсвіжішою версією.

=item *

Що ви точно описали ваду та способи її відтворення.
