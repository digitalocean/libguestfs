...
there is a program called F<utils/boot-benchmark/boot-benchmark> which does
...
In the libguestfs source directory, in F<utils/boot-analysis> is a program
...
In the libguestfs source, F<utils/boot-benchmark/boot-benchmark-range.pl> is
