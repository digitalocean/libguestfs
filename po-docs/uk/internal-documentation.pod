...
XXX Див. також F<v2v/utils.ml>:find_uefi_firmware
...
=head4 Функція C<fish/inspect.c:make_mapname>
...
=head4 Функція C<fish/inspect.c:inspect_do_decrypt>
...
=head4 Функція C<fish/options.c:display_short_options>
...
=head4 Функція C<fish/options.c:display_long_options>
...
=head3 Файл F<python/guestfs-py-byhand.c>
