...
Не запускайте libguestfs від імені користувача root.
...
Скористайтеся пропрієтарною програмою vdiskmanager з VMware для перетворення
образу у простий (raw) формат.
