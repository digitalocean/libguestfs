...
Скористайтеся пакунком з EPEL 5: L<https://fedoraproject.org/wiki/EPEL>

=item RHEL 6.2-6.3

Є частиною типового набору для встановлення. У RHEL 6 (і лише тут) вам слід
встановити C<libguestfs-winsupport>, щоб мати змогу працювати з гостьовими
системами Windows.

=item RHEL 6.4

Ви можете скористатися сховищем пакунків для попереднього перегляду. З
оголошенням про нього можна ознайомитися тут:
...
L<http://packages.debian.org/search?keywords=libguestfs> (завдяки Hilko
Bengen).
