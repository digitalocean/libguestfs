...
Older versions of virt-v2v could install these drivers for certain guests.
This version of virt-v2v does I<not> attempt to install these drivers, but
will warn you if they are not installed already.
