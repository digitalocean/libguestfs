...
right disk driver (eg. C<viostor.sys>).  If you experience this error, here
...
C</usr/share/virtio-win>, and that virt-v2v did not print any warning about
...
Enable boot debugging and check the C<viostor.sys> driver is being loaded.
...
grab the file C</var/log/vdsm/vdsm.log> which will contain detailed error
