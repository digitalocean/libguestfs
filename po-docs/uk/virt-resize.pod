...
=head2 ЗМІНА РОЗМІРІВ ВІРТУАЛЬНИХ МАШИН WINDOWS
...
partitions.  In rare cases you may need to S<C<dd if=/dev/zero
of=/dev/sdXN>> first to ensure the target partition is zeroed.
