...
See also: L</sfdisk-l>, L</sfdisk-N>, L</part-init>
...
See also: L</sfdisk>, the L<sfdisk(8)> manpage and L</part-disk>
...
To upload a compressed tarball, use L</tgz-in> or L</txz-in>.
...
To download a compressed tarball, use L</tgz-out> or L</txz-out>.
...
See also L</get-umask>, L<umask(2)>, L</mknod>, L</mkdir>.
