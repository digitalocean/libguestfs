...
=head2 Subdirectory F<src>

=head3 File F<src/actions-support.c>

Helper functions for the actions code in F<src/actions-*.c>.

=head3 File F<src/appliance.c>

This file deals with building the libguestfs appliance.

=head4 Function C<src/appliance.c:guestfs_int_build_appliance>
...
=head4 Function C<src/appliance.c:build_supermin_appliance>
...
=head4 Function C<src/appliance.c:run_supermin_build>
...
=head4 Function C<src/appliance.c:find_path>
...
=head4 Function C<src/appliance.c:dir_contains_file>
...
=head4 Function C<src/appliance.c:dir_contains_files>
...
=head4 Function C<src/appliance.c:guestfs_int_get_uefi>
...
=head4 Function C<src/command.c:guestfs_int_new_command>
...
=head4 Function C<src/command.c:guestfs_int_cmd_add_arg>
...
=head4 Function C<src/command.c:guestfs_int_cmd_add_arg_format>
...
=head4 Function C<src/command.c:guestfs_int_cmd_add_string_unquoted>
...
=head4 Function C<src/command.c:guestfs_int_cmd_add_string_quoted>
...
=head4 Function C<src/command.c:guestfs_int_cmd_set_stdout_callback>
...
=head4 Function C<src/command.c:guestfs_int_cmd_set_stderr_to_stdout>
...
=head4 Function C<src/command.c:guestfs_int_cmd_clear_capture_errors>
...
=head4 Function C<src/command.c:guestfs_int_cmd_clear_close_files>
...
=head4 Function C<src/command.c:guestfs_int_cmd_set_child_callback>
...
=head4 Function C<src/command.c:guestfs_int_cmd_set_child_rlimit>
...
=head4 Function C<src/command.c:finish_command>
...
=head4 Function C<src/command.c:loop>
...
=head4 Function C<src/command.c:guestfs_int_cmd_run>
...
=head4 Function C<src/command.c:guestfs_int_cmd_pipe_run>
...
=head4 Function C<src/command.c:guestfs_int_cmd_pipe_wait>
...
=head4 Function C<src/command.c:guestfs_int_cmd_get_pipe_errors>
...
=head4 Function C<src/command.c:guestfs_int_cmd_close>
...
=head4 Function C<src/command.c:process_line_buffer>
...
=head4 Function C<src/conn-socket.c:guestfs_int_new_conn_socket_listening>
...
=head4 Function C<src/conn-socket.c:guestfs_int_new_conn_socket_connected>
...
=head4 Function C<src/drives.c:create_drive_file>
...
=head4 Function C<src/drives.c:create_drive_dev_null>
...
=head4 Function C<src/drives.c:drive_to_string>
...
=head4 Function C<src/drives.c:add_drive_to_handle_at>
...
=head4 Function C<src/drives.c:add_drive_to_handle>
...
=head4 Function C<src/drives.c:guestfs_int_add_dummy_appliance_drive>
...
=head4 Function C<src/drives.c:guestfs_int_free_drives>
...
=head4 Function C<src/drives.c:valid_format_iface>
...
=head4 Function C<src/drives.c:valid_disk_label>
...
=head4 Function C<src/drives.c:valid_hostname>
...
=head4 Function C<src/drives.c:valid_port>
...
=head4 Function C<src/drives.c:guestfs_impl_remove_drive>
...
=head4 Function C<src/drives.c:guestfs_int_checkpoint_drives>
...
=head4 Function C<src/drives.c:guestfs_impl_debug_drives>
...
=head4 Function C<src/errors.c:guestfs_int_warning>
...
=head4 Function C<src/errors.c:guestfs_int_debug>
...
=head4 Function C<src/errors.c:guestfs_int_trace>
...
=head4 Function C<src/errors.c:guestfs_int_error_errno>
...
=head4 Function C<src/errors.c:guestfs_int_perrorf>
...
=head4 Function C<src/errors.c:guestfs_int_launch_failed_error>
...
=head4 Function C<src/errors.c:guestfs_int_unexpected_close_error>
...
=head4 Function C<src/errors.c:guestfs_int_launch_timeout>
...
=head4 Function C<src/errors.c:guestfs_int_external_command_failed>
...
=head3 File F<src/events.c>

=head4 Function C<src/events.c:replace_old_style_event_callback>
...
=head3 File F<src/guestfs-internal-all.h>
...
F<src/guestfs-internal.h> instead.  If you need a definition used by only
the frontend (non-daemon) parts of libguestfs, try
F<src/guestfs-internal-frontend.h>.  If a definition is used by only a
single tool, it should not be in any shared header file at all.

=head3 File F<src/guestfs-internal-frontend.h>
...
=head3 File F<src/guestfs-internal.h>

This header file is included in the libguestfs library (F<src/>)  only.

See also F<src/guestfs-internal-frontend.h> and
F<src/guestfs-internal-all.h>

=head4 Structure C<src/guestfs-internal.h:event>
...
=head4 Structure C<src/guestfs-internal.h:drive>
...
=head4 Structure C<src/guestfs-internal.h:backend_ops>
...
=head4 Structure C<src/guestfs-internal.h:connection>
...
=head4 Structure C<src/guestfs-internal.h:error_cb_stack>
...
=head4 Structure C<src/guestfs-internal.h:cached_feature>
...
=head4 Structure C<src/guestfs-internal.h:guestfs_h>
...
=head4 Structure C<src/guestfs-internal.h:version>
...
Used for storing major.minor.micro version numbers.  See F<src/version.c>
for more information.

=head4 Structure C<src/guestfs-internal.h:inspect_fs>
...
C<is_root> flag set are inspection roots, each corresponding to a single
guest.  Note that a filesystem can be shared between multiple guests.

=head3 File F<src/guid.c>

=head4 Function C<src/guid.c:guestfs_int_validate_guid>
...
=head4 Function C<src/handle.c:shutdown_backend>
...
=head4 Function C<src/handle.c:close_handles>
...
=head4 Function C<src/handle.c:guestfs_int_get_backend_setting_bool>
...
=head3 File F<src/inspect.c>

This file, and the other C<src/inspect*.c> files, handle inspection.  See
L<guestfs(3)/INSPECTION>.

=head4 Function C<src/inspect.c:guestfs_impl_inspect_os>
...
=head4 Function C<src/inspect.c:collect_coreos_inspection_info>
...
=head4 Function C<src/inspect.c:check_for_duplicated_bsd_root>
...
=head4 Function C<src/inspect.c:guestfs_int_download_to_tmp>
...
=head3 File F<src/launch-direct.c>

Implementation of the C<direct> backend.

For more details see L<guestfs(3)/BACKENDS>.

=head3 File F<src/launch-libvirt.c>

=head4 Function C<src/launch-libvirt.c:get_source_format_or_autodetect>
...
=head4 Function C<src/launch-libvirt.c:make_qcow2_overlay>
...
=head4 Function C<src/launch.c:guestfs_int_timeval_diff>
...
=head4 Function C<src/launch.c:guestfs_impl_max_disks>
...
=head4 Function C<src/launch.c:guestfs_impl_wait_ready>
...
=head4 Function C<src/launch.c:valid_term>
...
=head4 Function C<src/launch.c:guestfs_int_appliance_command_line>
...
=head4 Function C<src/launch.c:guestfs_int_get_cpu_model>
...
=head4 Function C<src/launch.c:guestfs_int_create_socketname>
...
=head4 Function C<src/launch.c:guestfs_int_register_backend>
...
=head4 Function C<src/launch.c:guestfs_int_set_backend>
...
=head3 File F<src/private-data.c>
...
=head4 Structure C<src/private-data.c:pda_entry>
...
generated actions (F<src/actions-*.c>).  There are five different cases to
consider:
...
=head4 Function C<src/proto.c:child_cleanup>
...
=head4 Function C<src/proto.c:guestfs_int_progress_message_callback>
...
=head4 Function C<src/proto.c:guestfs_int_log_message_callback>
...
=head4 Function C<src/proto.c:check_daemon_socket>
...
=head4 Function C<src/proto.c:guestfs_int_send_file>
...
=head4 Function C<src/proto.c:send_file_data>
...
=head4 Function C<src/proto.c:send_file_cancellation>
...
=head4 Function C<src/proto.c:send_file_complete>
...
=head4 Function C<src/proto.c:recv_from_daemon>
...
=head4 Function C<src/proto.c:guestfs_int_recv>
...
=head4 Function C<src/proto.c:guestfs_int_recv_discard>
...
=head4 Function C<src/proto.c:guestfs_int_recv_file>
...
=head4 Function C<src/proto.c:receive_file_data>
...
=head3 File F<src/qemu.c>

Functions to handle qemu versions and features.

=head4 Function C<src/qemu.c:guestfs_int_test_qemu>
...
=head4 Function C<src/qemu.c:parse_qemu_version>
...
=head4 Function C<src/qemu.c:guestfs_int_qemu_supports>
...
=head4 Function C<src/qemu.c:guestfs_int_qemu_supports_device>
...
=head4 Function C<src/qemu.c:guestfs_int_qemu_supports_virtio_scsi>
...
=head4 Function C<src/qemu.c:guestfs_int_qemu_escape_param>
...
=head4 Function C<src/qemu.c:guestfs_int_drive_source_qemu_param>
...
=head4 Function C<src/qemu.c:guestfs_int_discard_possible>
...
=head4 Function C<src/qemu.c:guestfs_int_free_qemu_data>
...
=head4 Function C<src/stringsbuf.c:guestfs_int_add_string_nodup>
...
=head4 Function C<src/stringsbuf.c:guestfs_int_add_string>
...
=head4 Function C<src/stringsbuf.c:guestfs_int_add_sprintf>
...
=head4 Function C<src/stringsbuf.c:guestfs_int_end_stringsbuf>
...
=head4 Function C<src/stringsbuf.c:guestfs_int_free_stringsbuf>
...
=head3 File F<src/tmpdirs.c>

Handle temporary directories.

=head4 Function C<src/tmpdirs.c:set_abs_path>
...
=head4 Function C<src/tmpdirs.c:guestfs_impl_get_tmpdir>
...
=head4 Function C<src/tmpdirs.c:guestfs_impl_get_cachedir>
...
=head4 Function C<src/tmpdirs.c:guestfs_impl_get_sockdir>
...
=head4 Function C<src/tmpdirs.c:guestfs_int_lazy_make_tmpdir>
...
=head4 Function C<src/tmpdirs.c:guestfs_int_lazy_make_supermin_appliance_dir>
...
=head4 Function C<src/tmpdirs.c:guestfs_int_recursive_remove_dir>
...
=head4 Function C<src/umask.c:guestfs_int_getumask>
...
=head4 Function C<src/umask.c:get_umask_from_proc>
...
=head4 Function C<src/umask.c:get_umask_from_fork>
...
=head4 Function C<src/unit-tests.c:test_split>
...
=head4 Function C<src/unit-tests.c:test_concat>
...
=head4 Function C<src/unit-tests.c:test_join>
...
=head4 Function C<src/unit-tests.c:test_validate_guid>
...
=head4 Function C<src/unit-tests.c:test_drive_name>
...
=head4 Function C<src/unit-tests.c:test_drive_index>
...
=head4 Function C<src/unit-tests.c:test_getumask>
...
=head4 Function C<src/unit-tests.c:test_command>
...
=head4 Function C<src/unit-tests.c:test_qemu_escape_param>
...
=head4 Function C<src/unit-tests.c:test_timeval_diff>
...
=head4 Function C<src/utils.c:guestfs_int_split_string>
...
=head4 Function C<src/utils.c:guestfs_int_exit_status_to_string>
...
=head4 Function C<src/utils.c:guestfs_int_random_string>
...
=head4 Function C<src/utils.c:guestfs_int_drive_name>
...
=head4 Function C<src/utils.c:guestfs_int_drive_index>
...
=head4 Function C<src/utils.c:guestfs_int_is_true>
...
=head4 Function C<src/utils.c:guestfs_int_fadvise_normal>
...
=head4 Function C<src/utils.c:guestfs_int_fadvise_sequential>
...
=head4 Function C<src/utils.c:guestfs_int_fadvise_random>
...
=head4 Function C<src/utils.c:guestfs_int_fadvise_noreuse>
...
=head4 Function C<src/utils.c:guestfs_int_fadvise_dontneed>
...
=head4 Function C<src/utils.c:guestfs_int_fadvise_willneed>
...
=head4 Function C<src/utils.c:guestfs_int_shell_unquote>
...
=head3 File F<src/version.c>

This file provides simple version number management.

=head4 Function C<src/version.c:guestfs_int_version_from_x_y>
...
=head4 Function C<src/version.c:guestfs_int_version_from_x_y_re>
...
=head4 Function C<src/version.c:guestfs_int_version_from_x_y_or_x>
...
=head3 File F<src/wait.c>

=head4 Function C<src/wait.c:guestfs_int_waitpid>
...
=head4 Function C<src/wait.c:guestfs_int_waitpid_noerror>
...
=head4 Function C<src/wait.c:guestfs_int_wait4>
...
=head3 File F<src/whole-file.c>

=head4 Function C<src/whole-file.c:guestfs_int_read_whole_file>
...
=head2 Subdirectory F<cat>

=head3 File F<cat/visit.c>
...
=head4 Function C<cat/visit.c:visit>
...
=head4 Function C<daemon/guestfsd.c:udev_settle>
...
=head2 Subdirectory F<df>

=head3 File F<df/domains.c>
...
=head4 Function C<df/domains.c:free_domains>
...
=head4 Function C<df/domains.c:get_all_libvirt_domains>
...
=head3 File F<df/estimate-max-threads.c>

=head4 Function C<df/estimate-max-threads.c:estimate_max_threads>
...
=head4 Function C<df/estimate-max-threads.c:read_line_from>
...
=head4 Function C<df/parallel.c:start_threads>
...
=head4 Function C<fish/decrypt.c:inspect_do_decrypt>
...
=head3 File F<fish/display-options.c>
...
=head4 Function C<fish/display-options.c:display_short_options>
...
=head4 Function C<fish/display-options.c:display_long_options>
...
=head3 File F<fish/domain.c>

Implements the guestfish (and other tools) I<-d> option.

=head4 Function C<fish/domain.c:add_libvirt_drives>
...
=head4 Function C<fish/file-edit.c:edit_file_editor>
...
=head4 Function C<fish/file-edit.c:edit_file_perl>
...
=head4 Function C<fish/inspect.c:inspect_mount_handle>
...
=head4 Function C<fish/inspect.c:print_inspect_prompt>
...
=head3 File F<fish/keys.c>

=head4 Function C<fish/keys.c:read_key>
...
=head4 Function C<fish/options.c:option_a>
...
=head4 Function C<fish/options.c:option_d>
...
=head4 Function C<fish/options.c:display_mountpoints_on_failure>
...
=head4 Function C<fish/progress.c:progress_bar_free>
...
=head4 Function C<fish/progress.c:progress_bar_reset>
...
=head4 Function C<fish/progress.c:estimate_remaining_time>
...
=head4 Function C<fish/progress.c:progress_bar_set>
...
=head3 File F<fish/windows.c>

This file implements C<win:> Windows file path support in L<guestfish(1)>.

=head4 Function C<fish/windows.c:is_windows>
...
=head4 Function C<fish/windows.c:windows_path>
...
=head4 Function C<p2v/conversion.c:start_qemu_nbd>
...
=head4 Function C<p2v/conversion.c:connect_with_source_port>
...
=head4 Function C<p2v/conversion.c:generate_dmesg_file>
...
port forward to the local L<qemu-nbd(8)> server which is serving the content
of that hard disk.  The remote port for each data connection is assigned by
ssh.  See C<open_data_connection> and C<start_remote_conversion>.
