...
The C<server> string is documented in L</guestfs_add_drive_opts>.
...
(Not all NBD servers support this feature.)
...
The appliance backend does not support readonly connections because of a bug
in qemu: L<https://bugs.launchpad.net/qemu/+bug/1155677>
