...
directory.  This is the UML kernel.  You should set C<LIBGUESTFS_QEMU> to
point to this file.
...
to set C<LIBGUESTFS_QEMU> to point to the kernel image, eg:

 make check-uml LIBGUESTFS_QEMU=~/d/linux/vmlinux
