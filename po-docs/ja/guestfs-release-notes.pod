...
to commit dfa25a46e35b87ae8a5e548d383e8bf75b4b4b26
...
Remote access to disks: Network Block Device (nbd), Gluster, Ceph (rbd) and
Sheepdog protocols are now supported.
