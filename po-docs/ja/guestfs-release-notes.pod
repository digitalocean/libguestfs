...
C<guestfs_copy_*> and C<guestfs_compare_*> functions to allow you to copy
and compare structs.
...
A flexible API for creating empty disk images from scratch.  This avoids you
needing to call out to external programs like L<qemu-img(1)>.
