...
The following functions: L</guestfs_btrfs_filesystem_resize>

=item B<grub>

The following functions: L</guestfs_grub_install>
...
The following functions: L</guestfs_modprobe>
...
The following functions: L</guestfs_ntfs_3g_probe>
...
The following functions: L</guestfs_realpath>
...
The following functions: L</guestfs_getcon> L</guestfs_setcon>

=item B<xz>

The following functions: L</guestfs_txz_in> L</guestfs_txz_out>

=item B<zerofree>

The following functions: L</guestfs_zerofree>
