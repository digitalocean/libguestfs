...
guestfs_internal_test_rinterr (guestfs_h *g)
{
  ...
  if (trace_flag) {
    ...
    fprintf (trace_fp, "%s", "internal_test_rinterr");
...
guestfs_internal_test_rconstoptstringerr (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_rconstoptstringerr");
    guestfs___trace_send_line (g);
  }
                                  ...
                                  size_t *size_r)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_rbufferout");
                                  ...
                                  const char *filename)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_set_output");
...
guestfs_internal_test_close_output (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_close_output");
    guestfs___trace_send_line (g);
  }
                                           ...
                                           char *const *creds)
{
  ...
  if (trace_flag) {
    ...
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "set_libvirt_supported_credentials");
    fputc (' ', trace_fp);
    fputc ('"', trace_fp);
    for (i = 0; creds[i]; ++i) {
      if (i > 0) fputc (' ', trace_fp);
      fputs (creds[i], trace_fp);
    }
    fputc ('"', trace_fp);
    guestfs___trace_send_line (g);
  }
                                          ...
                                          size_t cred_size)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "set_libvirt_requested_credential");
    fprintf (trace_fp, " %d", index);
    fputc (' ', trace_fp);
    guestfs___print_BufferIn (trace_fp, cred, cred_size);
    guestfs___trace_send_line (g);
  }
...
guestfs_parse_environment (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "parse_environment");
    guestfs___trace_send_line (g);
  }
                     ...
                     const char *file)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "get_e2attrs");
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "get_e2attrs",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
                          ...
                          const char *file)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "get_e2generation");
    fprintf (trace_fp, " \"%s\"", file);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "get_e2generation",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                           ...
                           int seeding)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "btrfs_set_seeding");
    fprintf (trace_fp, " \"%s\"", device);
    fputs (seeding ? " true" : " false", trace_fp);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "btrfs_set_seeding",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
...
guestfs_utsname (guestfs_h *g)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "utsname",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s = ", "utsname");
    fprintf (trace_fp, "<struct guestfs_utsname *>");
    guestfs___trace_send_line (g);
  }
                       ...
                       const struct guestfs_rsync_in_argv *optargs)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "rsync_in",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                              ...
                              const char *key)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "hivex_node_get_value");
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "hivex_node_get_value",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                              ...
                              const char *name)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "hivex_node_add_child");
    fprintf (trace_fp, " %" PRIi64, parent);
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "hivex_node_add_child",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                              ...
                              char *const *devices)
{
  ...
  if (trace_flag) {
    ...
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "ldmtool_scan_devices");
    fputc (' ', trace_fp);
    fputc ('"', trace_fp);
    for (i = 0; devices[i]; ++i) {
      if (i > 0) fputc (' ', trace_fp);
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "ldmtool_scan_devices",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
