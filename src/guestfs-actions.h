...
extern int guestfs_test0 (guestfs_h *handle, const char *str, const char *optstr, char *const *strlist, int b, int integer, int64_t integer64, const char *filein, const char *fileout);
...
extern const char *guestfs_test0rconstoptstring (guestfs_h *handle, const char *val);
extern const char *guestfs_test0rconstoptstringerr (guestfs_h *handle);
...
extern struct guestfs_lvm_pv *guestfs_test0rstruct (guestfs_h *handle, const char *val);
extern struct guestfs_lvm_pv *guestfs_test0rstructerr (guestfs_h *handle);
extern struct guestfs_lvm_pv_list *guestfs_test0rstructlist (guestfs_h *handle, const char *val);
extern struct guestfs_lvm_pv_list *guestfs_test0rstructlisterr (guestfs_h *handle);
...
extern int guestfs_set_path (guestfs_h *handle, const char *searchpath);
...
extern int guestfs_set_selinux (guestfs_h *handle, int selinux);
extern int guestfs_get_selinux (guestfs_h *handle);
extern int guestfs_set_trace (guestfs_h *handle, int trace);
extern int guestfs_get_trace (guestfs_h *handle);
extern int guestfs_set_direct (guestfs_h *handle, int direct);
extern int guestfs_get_direct (guestfs_h *handle);
extern int guestfs_set_recovery_proc (guestfs_h *handle, int recoveryproc);
extern int guestfs_get_recovery_proc (guestfs_h *handle);
extern int guestfs_add_drive_with_if (guestfs_h *handle, const char *filename, const char *iface);
extern int guestfs_add_drive_ro_with_if (guestfs_h *handle, const char *filename, const char *iface);
...
extern char *guestfs_aug_get (guestfs_h *handle, const char *augpath);
extern int guestfs_aug_set (guestfs_h *handle, const char *augpath, const char *val);
extern int guestfs_aug_insert (guestfs_h *handle, const char *augpath, const char *label, int before);
extern int guestfs_aug_rm (guestfs_h *handle, const char *augpath);
extern int guestfs_aug_mv (guestfs_h *handle, const char *src, const char *dest);
extern char **guestfs_aug_match (guestfs_h *handle, const char *augpath);
extern int guestfs_aug_save (guestfs_h *handle);
extern int guestfs_aug_load (guestfs_h *handle);
extern char **guestfs_aug_ls (guestfs_h *handle, const char *augpath);
...
extern int guestfs_vgcreate (guestfs_h *handle, const char *volgroup, char *const *physvols);
...
extern int guestfs_sfdisk (guestfs_h *handle, const char *device, int cyls, int heads, int sectors, char *const *lines);
...
extern char *guestfs_command (guestfs_h *handle, char *const *arguments);
extern char **guestfs_command_lines (guestfs_h *handle, char *const *arguments);
...
extern char *guestfs_debug (guestfs_h *handle, const char *subcmd, char *const *extraargs);
...
extern int guestfs_vg_activate (guestfs_h *handle, int activate, char *const *volgroups);
...
extern int guestfs_sfdiskM (guestfs_h *handle, const char *device, char *const *lines);
extern char *guestfs_zfile (guestfs_h *handle, const char *meth, const char *path);
...
extern char **guestfs_mountpoints (guestfs_h *handle);
extern int guestfs_mkmountpoint (guestfs_h *handle, const char *exemptpath);
extern int guestfs_rmmountpoint (guestfs_h *handle, const char *exemptpath);
extern char *guestfs_read_file (guestfs_h *handle, const char *path, size_t *size_r);
extern char **guestfs_grep (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_egrep (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_fgrep (guestfs_h *handle, const char *pattern, const char *path);
extern char **guestfs_grepi (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_egrepi (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_fgrepi (guestfs_h *handle, const char *pattern, const char *path);
extern char **guestfs_zgrep (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_zegrep (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_zfgrep (guestfs_h *handle, const char *pattern, const char *path);
extern char **guestfs_zgrepi (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_zegrepi (guestfs_h *handle, const char *regex, const char *path);
extern char **guestfs_zfgrepi (guestfs_h *handle, const char *pattern, const char *path);
extern char *guestfs_realpath (guestfs_h *handle, const char *path);
extern int guestfs_ln (guestfs_h *handle, const char *target, const char *linkname);
extern int guestfs_ln_f (guestfs_h *handle, const char *target, const char *linkname);
extern int guestfs_ln_s (guestfs_h *handle, const char *target, const char *linkname);
extern int guestfs_ln_sf (guestfs_h *handle, const char *target, const char *linkname);
extern char *guestfs_readlink (guestfs_h *handle, const char *path);
extern int guestfs_fallocate (guestfs_h *handle, const char *path, int len);
extern int guestfs_swapon_device (guestfs_h *handle, const char *device);
extern int guestfs_swapoff_device (guestfs_h *handle, const char *device);
extern int guestfs_swapon_file (guestfs_h *handle, const char *file);
extern int guestfs_swapoff_file (guestfs_h *handle, const char *file);
extern int guestfs_swapon_label (guestfs_h *handle, const char *label);
extern int guestfs_swapoff_label (guestfs_h *handle, const char *label);
extern int guestfs_swapon_uuid (guestfs_h *handle, const char *uuid);
extern int guestfs_swapoff_uuid (guestfs_h *handle, const char *uuid);
extern int guestfs_mkswap_file (guestfs_h *handle, const char *path);
extern int guestfs_inotify_init (guestfs_h *handle, int maxevents);
extern int64_t guestfs_inotify_add_watch (guestfs_h *handle, const char *path, int mask);
extern int guestfs_inotify_rm_watch (guestfs_h *handle, int wd);
extern struct guestfs_inotify_event_list *guestfs_inotify_read (guestfs_h *handle);
extern char **guestfs_inotify_files (guestfs_h *handle);
extern int guestfs_inotify_close (guestfs_h *handle);
extern int guestfs_setcon (guestfs_h *handle, const char *context);
extern char *guestfs_getcon (guestfs_h *handle);
extern int guestfs_mkfs_b (guestfs_h *handle, const char *fstype, int blocksize, const char *device);
extern int guestfs_mke2journal (guestfs_h *handle, int blocksize, const char *device);
extern int guestfs_mke2journal_L (guestfs_h *handle, int blocksize, const char *label, const char *device);
extern int guestfs_mke2journal_U (guestfs_h *handle, int blocksize, const char *uuid, const char *device);
extern int guestfs_mke2fs_J (guestfs_h *handle, const char *fstype, int blocksize, const char *device, const char *journal);
extern int guestfs_mke2fs_JL (guestfs_h *handle, const char *fstype, int blocksize, const char *device, const char *label);
extern int guestfs_mke2fs_JU (guestfs_h *handle, const char *fstype, int blocksize, const char *device, const char *uuid);
extern int guestfs_modprobe (guestfs_h *handle, const char *modulename);
extern char *guestfs_echo_daemon (guestfs_h *handle, char *const *words);
extern int guestfs_find0 (guestfs_h *handle, const char *directory, const char *files);
extern char *guestfs_case_sensitive_path (guestfs_h *handle, const char *path);
extern char *guestfs_vfs_type (guestfs_h *handle, const char *device);
extern int guestfs_truncate (guestfs_h *handle, const char *path);
extern int guestfs_truncate_size (guestfs_h *handle, const char *path, int64_t size);
extern int guestfs_utimens (guestfs_h *handle, const char *path, int64_t atsecs, int64_t atnsecs, int64_t mtsecs, int64_t mtnsecs);
extern int guestfs_mkdir_mode (guestfs_h *handle, const char *path, int mode);
extern int guestfs_lchown (guestfs_h *handle, int owner, int group, const char *path);
extern struct guestfs_stat_list *guestfs_lstatlist (guestfs_h *handle, const char *path, char *const *names);
extern struct guestfs_xattr_list *guestfs_lxattrlist (guestfs_h *handle, const char *path, char *const *names);
extern char **guestfs_readlinklist (guestfs_h *handle, const char *path, char *const *names);
extern char *guestfs_pread (guestfs_h *handle, const char *path, int count, int64_t offset, size_t *size_r);
extern int guestfs_part_init (guestfs_h *handle, const char *device, const char *parttype);
extern int guestfs_part_add (guestfs_h *handle, const char *device, const char *prlogex, int64_t startsect, int64_t endsect);
extern int guestfs_part_disk (guestfs_h *handle, const char *device, const char *parttype);
extern int guestfs_part_set_bootable (guestfs_h *handle, const char *device, int partnum, int bootable);
extern int guestfs_part_set_name (guestfs_h *handle, const char *device, int partnum, const char *name);
extern struct guestfs_partition_list *guestfs_part_list (guestfs_h *handle, const char *device);
extern char *guestfs_part_get_parttype (guestfs_h *handle, const char *device);
extern int guestfs_fill (guestfs_h *handle, int c, int len, const char *path);
extern int guestfs_available (guestfs_h *handle, char *const *groups);
extern int guestfs_dd (guestfs_h *handle, const char *src, const char *dest);
extern int64_t guestfs_filesize (guestfs_h *handle, const char *file);
extern int guestfs_lvrename (guestfs_h *handle, const char *logvol, const char *newlogvol);
extern int guestfs_vgrename (guestfs_h *handle, const char *volgroup, const char *newvolgroup);
extern char *guestfs_initrd_cat (guestfs_h *handle, const char *initrdpath, const char *filename, size_t *size_r);
