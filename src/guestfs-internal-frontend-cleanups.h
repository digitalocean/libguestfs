...
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_int_bool (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_int_bool_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_lvm_pv (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_lvm_pv_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_lvm_vg (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_lvm_vg_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_lvm_lv (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_lvm_lv_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_stat (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_stat_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_statvfs (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_statvfs_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_dirent (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_dirent_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_version (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_version_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_xattr (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_xattr_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_inotify_event (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_inotify_event_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_partition (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_partition_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_application (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_application_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_application2 (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_application2_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_isoinfo (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_isoinfo_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_mdstat (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_mdstat_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_btrfssubvolume (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_btrfssubvolume_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_xfsinfo (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_xfsinfo_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_utsname (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_utsname_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_hivex_node (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_hivex_node_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_hivex_value (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_hivex_value_list (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_internal_mountable (void *ptr);
extern GUESTFS_DLL_PUBLIC void guestfs___cleanup_free_internal_mountable_list (void *ptr);
