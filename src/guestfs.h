...
extern char *guestfs_mkdtemp (guestfs_h *g, const char *template);
...
extern int guestfs_mount_options (guestfs_h *g, const char *options, const char *device, const char *mountpoint);

#define LIBGUESTFS_HAVE_MOUNT_RO 1
extern int guestfs_mount_ro (guestfs_h *g, const char *device, const char *mountpoint);

#define LIBGUESTFS_HAVE_MOUNT_VFS 1
extern int guestfs_mount_vfs (guestfs_h *g, const char *options, const char *vfstype, const char *device, const char *mountpoint);
...
extern int guestfs_set_attach_method (guestfs_h *g, const char *attachmethod);
...
extern int guestfs_set_qemu (guestfs_h *g, const char *qemu);
...
extern int guestfs_test0 (guestfs_h *g, const char *str, const char *optstr, char *const *strlist, int b, int integer, int64_t integer64, const char *filein, const char *fileout, const char *bufferin, size_t bufferin_size);

extern int guestfs_test0rbool (guestfs_h *g, const char *val);

extern int guestfs_test0rboolerr (guestfs_h *g);

extern const char *guestfs_test0rconstoptstring (guestfs_h *g, const char *val);

extern const char *guestfs_test0rconstoptstringerr (guestfs_h *g);

extern const char *guestfs_test0rconststring (guestfs_h *g, const char *val);

extern const char *guestfs_test0rconststringerr (guestfs_h *g);

extern char **guestfs_test0rhashtable (guestfs_h *g, const char *val);

extern char **guestfs_test0rhashtableerr (guestfs_h *g);

extern int guestfs_test0rint (guestfs_h *g, const char *val);

extern int64_t guestfs_test0rint64 (guestfs_h *g, const char *val);

extern int64_t guestfs_test0rint64err (guestfs_h *g);

extern int guestfs_test0rinterr (guestfs_h *g);

extern char *guestfs_test0rstring (guestfs_h *g, const char *val);

extern char *guestfs_test0rstringerr (guestfs_h *g);

extern char **guestfs_test0rstringlist (guestfs_h *g, const char *val);

extern char **guestfs_test0rstringlisterr (guestfs_h *g);

extern struct guestfs_lvm_pv *guestfs_test0rstruct (guestfs_h *g, const char *val);

extern struct guestfs_lvm_pv *guestfs_test0rstructerr (guestfs_h *g);

extern struct guestfs_lvm_pv_list *guestfs_test0rstructlist (guestfs_h *g, const char *val);

extern struct guestfs_lvm_pv_list *guestfs_test0rstructlisterr (guestfs_h *g);
...
extern char *guestfs_vfs_label (guestfs_h *g, const char *device);
...
extern char *guestfs_vfs_uuid (guestfs_h *g, const char *device);
