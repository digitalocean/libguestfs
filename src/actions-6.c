              ...
              const char *dest)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "cp_a",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                   ...
                   const char *path)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "strings_e",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
              ...
              const char *path)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "wc_c",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                ...
                const char *path)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "tail_n",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
                  ...
                  const char *device)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "mkswap_L",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                       ...
                       const char *device)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "mke2journal_L",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
...
guestfs_list_9p (guestfs_h *g)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "list_9p",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
              ...
              const char *path)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs___error_errno (g, errnum, "%s: %s", "rm_f",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
