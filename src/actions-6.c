                            ...
                            const char *val)
{
  ...
  if (trace_flag) {
    ...
    fprintf (trace_fp, "%s", "internal_test_rint");
...
guestfs_internal_test_rint64err (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_rint64err");
    guestfs___trace_send_line (g);
  }
                                    ...
                                    const char *val)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_rconststring");
    fprintf (trace_fp, " \"%s\"", val);
    guestfs___trace_send_line (g);
  }
                               ...
                               const char *val)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_test_rstruct");
    fprintf (trace_fp, " \"%s\"", val);
    guestfs___trace_send_line (g);
  }
                     ...
                     const char *filename)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "disk_format");
...
guestfs_get_libvirt_requested_credentials (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "get_libvirt_requested_credentials");
    guestfs___trace_send_line (g);
  }
                           ...
                           const struct guestfs_tar_out_opts_argv *optargs)
{
  ...
  if (trace_flag) {
    ...
    if (optargs->bitmask & GUESTFS_TAR_OUT_OPTS_NUMERICOWNER_BITMASK) {
      fprintf (trace_fp, " \"%s:%s\"", "numericowner", optargs->numericowner ? "true" : "false");
    }
    if (optargs->bitmask & GUESTFS_TAR_OUT_OPTS_EXCLUDES_BITMASK) {
      fprintf (trace_fp, " \"%s:", "excludes");
      for (i = 0; optargs->excludes[i] != NULL; ++i) {
        if (i > 0) fputc (' ', trace_fp);
        fputs (optargs->excludes[i], trace_fp);
      }
      fputc ('\"', trace_fp);
    }
    guestfs___trace_send_line (g);
              ...
              const char *dest)
{
  ...
  if (guestfs___check_appliance_up (g, "cp_a") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "cp_a", "-1");
    return -1;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_CP_A, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "cp_a", "-1");
    return -1;
                   ...
                   const char *path)
{
  ...
  if (guestfs___check_appliance_up (g, "strings_e") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "strings_e", "NULL");
    return NULL;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_STRINGS_E, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "strings_e", "NULL");
    return NULL;
              ...
              const char *path)
{
  ...
  if (guestfs___check_appliance_up (g, "wc_c") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_c", "-1");
    return -1;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_WC_C, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "wc_c", "-1");
    return -1;
                ...
                const char *path)
{
  ...
  if (guestfs___check_appliance_up (g, "tail_n") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tail_n", "NULL");
    return NULL;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_TAIL_N, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "tail_n", "NULL");
    return NULL;
                  ...
                  const char *device)
{
  ...
  if (guestfs___check_appliance_up (g, "mkswap_L") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkswap_L", "-1");
    return -1;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_MKSWAP_L, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mkswap_L", "-1");
    return -1;
                       ...
                       const char *device)
{
  ...
  if (guestfs___check_appliance_up (g, "mke2journal_L") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mke2journal_L", "-1");
    return -1;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_MKE2JOURNAL_L, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "mke2journal_L", "-1");
    return -1;
                               ...
                               char *const *names)
{
  ...
  if (trace_flag) {
    ...
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "internal_readlinklist");
    fprintf (trace_fp, " \"%s\"", path);
    fputc (' ', trace_fp);
    fputc ('"', trace_fp);
    for (i = 0; names[i]; ++i) {
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "internal_readlinklist",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
...
guestfs_list_9p (guestfs_h *g)
{
  ...
  if (guestfs___check_appliance_up (g, "list_9p") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_9p", "NULL");
    return NULL;
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_LIST_9P, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "list_9p", "NULL");
    return NULL;
                   ...
                   const char *md)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "md_detail",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
                   ...
                   const char *label)
{
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "set_label",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                 ...
                 const char *isofile)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "isoinfo");
    fprintf (trace_fp, " \"%s\"", isofile);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "isoinfo",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
                          ...
                          int64_t generation)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "set_e2generation");
    fprintf (trace_fp, " \"%s\"", file);
    fprintf (trace_fp, " %" PRIi64, generation);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "set_e2generation",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                              ...
                              const char *filesystem)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "filesystem_available");
    fprintf (trace_fp, " \"%s\"", filesystem);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "filesystem_available",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                       ...
                       const char *device)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "pvchange_uuid");
    fprintf (trace_fp, " \"%s\"", device);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "pvchange_uuid",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
...
guestfs_pvchange_uuid_all (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "pvchange_uuid_all");
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "pvchange_uuid_all",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                        ...
                        const struct guestfs_rsync_out_argv *optargs)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "rsync_out");
    fprintf (trace_fp, " \"%s\"", src);
    fprintf (trace_fp, " \"%s\"", remote);
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "rsync_out",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                         ...
                         int64_t nodeh)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "hivex_node_name");
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "hivex_node_name",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
                           ...
                           int64_t nodeh)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "hivex_node_values");
    fprintf (trace_fp, " %" PRIi64, nodeh);
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "hivex_node_values",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s = ", "hivex_node_values");
    fprintf (trace_fp, "<struct guestfs_hivex_value_list *>");
    guestfs___trace_send_line (g);
  }
              ...
              const char *path)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "rm_f");
    fprintf (trace_fp, " \"%s\"", path);
    guestfs___trace_send_line (g);
  }

  if (guestfs___check_appliance_up (g, "rm_f") == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "rm_f", "-1");
    return -1;
  ...
  args.path = (char *) path;
  serial = guestfs___send (g, GUESTFS_PROC_RM_F,
                           progress_hint, 0,
  ...
  r = guestfs___recv (g, "rm_f", &hdr, &err,
        NULL, NULL);
  if (r == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
  ...
  if (guestfs___check_reply_header (g, &hdr, GUESTFS_PROC_RM_F, serial) == -1) {
    if (trace_flag)
      guestfs___trace (g, "%s = %s (error)",
                       "rm_f", "-1");
    return -1;
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "rm_f",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return -1;
                     ...
                     const struct guestfs_mktemp_argv *optargs)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "mktemp");
    fprintf (trace_fp, " \"%s\"", tmpl);
    if (optargs->bitmask & GUESTFS_MKTEMP_SUFFIX_BITMASK) {
      fprintf (trace_fp, " \"%s:%s\"", "suffix", optargs->suffix);
    }
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "mktemp",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
...
guestfs_list_ldm_partitions (guestfs_h *g)
{
  ...
  if (trace_flag) {
    trace_fp = guestfs___trace_open (g);
    fprintf (trace_fp, "%s", "list_ldm_partitions");
    guestfs___trace_send_line (g);
  }
  ...
  if (hdr.status == GUESTFS_STATUS_ERROR) {
    ...
    if (errnum <= 0)
      ...
      guestfs_error_errno (g, errnum, "%s: %s", "list_ldm_partitions",
                           err.error_message);
    free (err.error_message);
    free (err.errno_string);
    return NULL;
