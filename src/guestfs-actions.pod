...
In new code, use the L</guestfs_add_drive_opts> call instead.
...
This function is deprecated.
In new code, use the L</guestfs_mkfs_opts> call instead.
...
This function is deprecated.
In new code, use the L</guestfs_mount_options> call instead.
...
This function is deprecated.
In new code, use the L</guestfs_ntfsresize_opts> call instead.
