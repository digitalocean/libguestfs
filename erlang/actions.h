...
ETERM *run_aug_transform (ETERM *message);
...
ETERM *run_find_inode (ETERM *message);
...
ETERM *run_inspect_get_windows_software_hive (ETERM *message);
ETERM *run_inspect_get_windows_system_hive (ETERM *message);
...
ETERM *run_mksquashfs (ETERM *message);
